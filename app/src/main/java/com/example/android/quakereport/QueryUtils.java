...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject sample_json = new JSONObject(SAMPLE_JSON_RESPONSE);
            //Extract “features” JSONArray
            JSONArray features = sample_json.getJSONArray("features");
